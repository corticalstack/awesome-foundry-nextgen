...
| [08-10c-hosted-copilot-sdk-agent-runtime-model/](08-10c-hosted-copilot-sdk-agent-runtime-model/) | The 08-10 agent with per-request model and reasoning effort selection, switched mid-conversation without a new version or redeploy, plus a walk through the out-of-the-box telemetry of a hosted agent - [overview](08-10c-hosted-copilot-sdk-agent-runtime-model/08-10c-00-hosted-copilot-sdk-agent-runtime-model.md) and [notebook](08-10c-hosted-copilot-sdk-agent-runtime-model/08-10c-01-runtime-model-and-telemetry.ipynb) |
