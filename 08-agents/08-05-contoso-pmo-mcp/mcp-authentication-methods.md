...
- All five supported authentication methods (key-based, Entra agent identity, Entra project managed identity, OAuth passthrough, unauthenticated)
- How to store credentials in Foundry project connections
